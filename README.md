...
<!---
Rogercreador1-tech/Rogercreador1-tech is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
if comando:
    ...
    hablar("Hola, soy tu mini-Roger. ¿Qué necesitas?")
    while True:
        comando = escuchar_comando()
        if comando:
